...
export default async function ProfilePage() {
  ...
  const profileData: Pick<CustomerProfile, "full_name" | "phone" | "marketing_opt_in"> = {
  ...
  return (
    <CustomerStoreLayout userName={displayName} showPrimaryNav showCategoryNav={false}>
        ...
        <div className="space-y-6">
          <div className="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-gray-200">
            ...
            <div className="px-6 py-8 sm:px-10">
              <h2 className="mb-1 text-lg font-semibold text-gray-900">Personal details</h2>
              <p className="mb-6 text-sm text-gray-500">
                Used for orders, delivery updates, and marketing preferences.
              </p>
              <ProfileDetailsForm profile={profileData} email={user.email ?? ""} />
            </div>
